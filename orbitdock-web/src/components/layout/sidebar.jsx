...
const Sidebar = ({ routes, onCreateSession, open, onClose }) => {
  ...
  return (
    <>
      ...
      {open && <div class={styles.backdrop} onClick={onClose} aria-hidden="true" />}

      <aside class={`${styles.sidebar} ${open ? styles.sidebarOpen : ''}`}>
                  ...
                  >
                    ...
                    <div class={styles.sessionText}>
                      ...
                      <span class={styles.sessionMeta}>
                        {provider && <span class={styles.sessionProvider}>{provider}</span>}
                        ...
                        {session.is_worktree && session.worktree_id && (
                          <span class={styles.sessionWorktree}>
                            <svg
                              width="12"
                              height="12"
                              viewBox="0 0 24 24"
