...
const DiffAvailableBanner = ({ onOpen, onDismiss }) => (
  <div class={styles.banner} role="status" aria-live="polite">
    ...
    <button class={styles.bannerBody} onClick={onOpen} aria-label="Open code review panel">
      <span class={styles.label}>Files changed</span>
      <span class={styles.hint}>— click to review diff</span>
    </button>
    <button class={styles.dismiss} onClick={onDismiss} aria-label="Dismiss" title="Dismiss">
      <svg
        width="10"
        height="10"
        viewBox="0 0 12 12"
