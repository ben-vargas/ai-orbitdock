...
MACOS_PROVISIONING_PROFILE_UUID="${MACOS_PROVISIONING_PROFILE_UUID:-}"
MACOS_PROVISIONING_PROFILE_SPECIFIER="${MACOS_PROVISIONING_PROFILE_SPECIFIER:-}"
MACOS_PROVISIONING_PROFILE_XCODE_MANAGED="${MACOS_PROVISIONING_PROFILE_XCODE_MANAGED:-false}"
...
if [[ "$MACOS_PROVISIONING_PROFILE_XCODE_MANAGED" == "true" ]]; then
  ...
  if [[ -n "$MACOS_PROVISIONING_PROFILE_SPECIFIER" ]]; then
    XCODEBUILD_ARGS+=("PROVISIONING_PROFILE_SPECIFIER=$MACOS_PROVISIONING_PROFILE_SPECIFIER")
  fi

  if [[ -n "$MACOS_PROVISIONING_PROFILE_UUID" ]]; then
    XCODEBUILD_ARGS+=("PROVISIONING_PROFILE=$MACOS_PROVISIONING_PROFILE_UUID")
  fi
fi
