...
struct DesktopSidebarPanel: View {
  ...
  private func sidebarSessionRow(_ session: SessionSummary) -> some View {
  ...
  private func sidebarTitleColor(for session: SessionSummary, status: SessionDisplayStatus) -> Color {
