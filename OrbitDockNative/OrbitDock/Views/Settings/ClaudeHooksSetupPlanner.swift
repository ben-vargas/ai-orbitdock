...
enum ClaudeHooksSetupPlanner {
  nonisolated static func hooksConfigured(contents: String) -> Bool {
    contents.contains("orbitdock") || contents.contains("hook-forward")
  }

  nonisolated static func hooksConfigurationJSON(hookForwardPath: String) -> String {
    """
      "hooks": {
